...
| :---------: | :-----------------------------------: | :----------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------: |
|      1      |        Raspberry Pi 4 B (4 GB)        |                    Raspberry Pi 5 (8 GB)                     |                                      [Amazon bundle](https://www.amazon.com/dp/B0D2WYFS23)                                       |                                            Needs a 5 V / 5 A supply. See [Known issues](#known-issues)                                             |
...
|      9      |             Arduino Nano              |               Arduino Nano v3 (new bootloader)               |                                     [Amazon 3x bundle](https://www.amazon.com/dp/B07G99NNXL)                                     |                                                 Uploads at 115200 baud. See [Firmware](#firmware)                                                  |
|     13      |    Raspi Camera Module V2 (IMX219)    |                     Arducam 8.3MP IMX415                     |                                          [Amazon](https://www.amazon.com/dp/B0FG73N2BK)                                          | [Arducam docs](https://docs.arducam.com/Raspberry-Pi-Camera/Native-camera/8.3MP-IMX415/). Needs manual setup, see [Camera](#camera-arducam-imx415) |
|     14      |             Battery case              |                     4-cell battery case                      |                                     [Amazon 4x bundle](https://www.amazon.com/dp/B07TWD3GRJ)                                     |                                                          East to cut one of the bays out.                                                          |
|     15      |               Batteries               | Batteries salvaged from old laptop computers. No protection. |                                                                -                                                                 |                                                            Needs a BMS to work safely.                                                             |
|      -      |                   -                   |                          BMS board                           | [Mercadolibre (AR)](https://www.mercadolibre.com.ar/modulo-proteccion-carga-bateria-litio-3s-40a-12v-18650-bms/up/MLAU184006431) |                                                            Still don't know if it works                                                            |
|     17      |            DC-DC converter            |              DC-DC converter with USB-C output               |                                          [Amazon](https://www.amazon.com/dp/B0BCP86XPY)                                          |                                                    Bigger. Needed to cut a hole in the chassis.                                                    |
|     19      |             Caster wheel              |                      1-in caster wheels                      |                                      [Amazon 8x pack](https://www.amazon.com/dp/B09CTSLPCL)                                      |                                               Didn't notice I bought bigger wheels. Need replacing.                                                |
